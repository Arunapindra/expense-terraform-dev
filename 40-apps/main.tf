module "mysql" {
  ...
  subnet_id              = local.database_subnet_id  #FOR SUBNET ID , VPC SHOULD OUTPUTING THE SUBNETS AND ALSO SHOULD STORE IN PARAMETERS
...
module "backend" {
  ...
  subnet_id              = local.private_subnet_id  #FOR SUBNET ID , VPC SHOULD OUTPUTING THE SUBNETS AND ALSO SHOULD STORE IN PARAMETERS
